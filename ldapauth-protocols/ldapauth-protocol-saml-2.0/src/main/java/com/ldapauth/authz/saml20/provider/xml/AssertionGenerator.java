	...
	public Assertion generateAssertion(
		...
		try{
	        ...
	        if(saml20Details.getSignature().equalsIgnoreCase("RSAwithSHA1"))  {
				...
				config.registerSignatureAlgorithmURI("RSA", SignatureConstants.ALGO_ID_SIGNATURE_RSA_SHA384);
				...
				config.registerSignatureAlgorithmURI("RSA", SignatureConstants.ALGO_ID_SIGNATURE_NOT_RECOMMENDED_RSA_MD5);
				...
				config.registerSignatureAlgorithmURI("RSA", SignatureConstants.ALGO_ID_SIGNATURE_RSA_RIPEMD160);
				...
				config.registerSignatureAlgorithmURI("RSA", SignatureConstants.ALGO_ID_SIGNATURE_ECDSA_SHA1);
				...
				config.registerSignatureAlgorithmURI("RSA", SignatureConstants.ALGO_ID_SIGNATURE_ECDSA_SHA256);
				...
				config.registerSignatureAlgorithmURI("RSA", SignatureConstants.ALGO_ID_SIGNATURE_ECDSA_SHA384);
				...
				config.registerSignatureAlgorithmURI("RSA", SignatureConstants.ALGO_ID_SIGNATURE_ECDSA_SHA512);
				...
				config.registerSignatureAlgorithmURI("RSA", SignatureConstants.ALGO_ID_MAC_HMAC_NOT_RECOMMENDED_MD5);
				...
				config.registerSignatureAlgorithmURI("RSA", SignatureConstants.ALGO_ID_MAC_HMAC_SHA256);
				...
				config.registerSignatureAlgorithmURI("RSA", SignatureConstants.ALGO_ID_MAC_HMAC_SHA384);
				...
				config.registerSignatureAlgorithmURI("RSA", SignatureConstants.ALGO_ID_MAC_HMAC_SHA512);
				...
				config.registerSignatureAlgorithmURI("RSA", SignatureConstants.ALGO_ID_MAC_HMAC_RIPEMD160);
