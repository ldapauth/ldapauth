package com.ldapauth.authz.oauth2.provider.request;
...
import com.ldapauth.authz.oauth2.provider.DefaultSecurityContextAccessor;
import com.ldapauth.authz.oauth2.provider.OAuth2Request;
import com.ldapauth.authz.oauth2.provider.OAuth2RequestFactory;
import com.ldapauth.authz.oauth2.provider.SecurityContextAccessor;
...
public class DefaultOAuth2RequestFactory implements OAuth2RequestFactory {
	final static Logger _logger = LoggerFactory.getLogger(DefaultOAuth2RequestFactory.class);
	...
	public AuthorizationRequest createAuthorizationRequest(Map<String, String> authorizationParameters) {
		...
		_logger.trace("authorizationParameters {} " , authorizationParameters);
