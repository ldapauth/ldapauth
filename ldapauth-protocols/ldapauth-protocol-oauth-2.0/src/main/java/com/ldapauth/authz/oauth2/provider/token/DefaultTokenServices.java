...
import com.ldapauth.authz.oauth2.common.exceptions.InvalidScopeException;
...
import com.ldapauth.authz.oauth2.provider.ClientRegistrationException;
...
public class DefaultTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices,
	...
	final static Logger _logger = LoggerFactory.getLogger(DefaultTokenServices.class);
	...
	public OAuth2AccessToken createAccessToken(OAuth2Authentication authentication) throws AuthenticationException {
		_logger.trace("createAccessToken ");
		OAuth2AccessToken existingAccessToken = tokenStore.getAccessToken(authentication);
		OAuth2RefreshToken refreshToken = null;
		_logger.trace("existingAccessToken {}" , existingAccessToken != null);
		if (existingAccessToken != null) {
			if (existingAccessToken.isExpired()) {
				if (existingAccessToken.getRefreshToken() != null) {
					...
					// be sure...
					_logger.trace("removeRefreshToken ");
					tokenStore.removeRefreshToken(refreshToken);
				}
				_logger.trace("removeAccessToken ");
				tokenStore.removeAccessToken(existingAccessToken);
			}
			else {
				_logger.trace("storeAccessToken ");
	...
	private OAuth2AccessToken createAccessToken(OAuth2Authentication authentication, OAuth2RefreshToken refreshToken) {
		...
		_logger.trace("accessTokenEnhancer {}" , accessTokenEnhancer);
