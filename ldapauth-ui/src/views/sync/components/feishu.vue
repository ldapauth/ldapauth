   ...
   <div class="app-container1">
     <el-form ref="formRef" :model="form" :rules="rules" label-width="150px">
       <el-form-item :label="t('sync.common.label.baseApi')" prop="baseApi">
         <el-input v-model="form.baseApi" placeholder="https://open.feishu.cn" maxlength="255"  show-word-limit/>
       </el-form-item>
       <el-form-item :label="t('sync.common.label.rootId')">
         <el-input v-model="form.rootId" placeholder="default root 0" maxlength="64"  show-word-limit/>
       </el-form-item>
...
<script setup name="Sync-Component-feishu">
