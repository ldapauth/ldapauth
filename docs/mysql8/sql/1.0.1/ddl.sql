...
-- ----------------------------
-- Table structure for lda_client_apps
-- ----------------------------
DROP TABLE IF EXISTS `lda_client_apps`;
CREATE TABLE `lda_client_apps`  (
...
-- ----------------------------
-- Table structure for lda_client_apps_cas_details
-- ----------------------------
DROP TABLE IF EXISTS `lda_client_apps_cas_details`;
CREATE TABLE `lda_client_apps_cas_details`  (
...
-- ----------------------------
-- Table structure for lda_client_apps_jwt_details
-- ----------------------------
DROP TABLE IF EXISTS `lda_client_apps_jwt_details`;
CREATE TABLE `lda_client_apps_jwt_details`  (
    `id` bigint NOT NULL DEFAULT 0 COMMENT 'id',
    `device_type` tinyint NULL DEFAULT 0 COMMENT '设备类型，0=移动端 1=PC端 2=WEB端',
    `app_id` bigint NULL DEFAULT 0 COMMENT '应用ID',
    `subject` varchar(255)  NULL DEFAULT '' COMMENT '响应主体-username/mobile/email等',
...
-- ----------------------------
-- Table structure for lda_client_apps_login_log
-- ----------------------------
DROP TABLE IF EXISTS `lda_client_apps_login_log`;
CREATE TABLE `lda_client_apps_login_log`  (
...
-- ----------------------------
-- Table structure for lda_client_apps_oidc_details
-- ----------------------------
DROP TABLE IF EXISTS `lda_client_apps_oidc_details`;
CREATE TABLE `lda_client_apps_oidc_details`  (
    `id` bigint NOT NULL DEFAULT 0 COMMENT 'id',
    `device_type` tinyint NULL DEFAULT 0 COMMENT '设备类型，0=移动端 1=PC端 2=WEB端',
    `app_id` bigint NULL DEFAULT 0 COMMENT '应用ID',
    `client_id` varchar(255)  NULL DEFAULT '' COMMENT '客户端ID',
...
-- ----------------------------
-- Table structure for lda_client_apps_saml_details
-- ----------------------------
DROP TABLE IF EXISTS `lda_client_apps_saml_details`;
CREATE TABLE `lda_client_apps_saml_details`  (
     `id` bigint NOT NULL DEFAULT 0 COMMENT 'id',
     `device_type` tinyint NULL DEFAULT 0 COMMENT '设备类型，0=移动端 1=PC端 2=WEB端',
     `app_id` bigint NULL DEFAULT 0 COMMENT '应用ID',
     `subject` varchar(255)  NULL DEFAULT '' COMMENT '响应主体-username/mobile/email等',
